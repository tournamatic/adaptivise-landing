...
export default function BlogIndexPage({ posts }: InferGetStaticPropsType<typeof getStaticProps>) {
  return (
    <Page
      title="Adaptivise Blog"
      description="Articles on annuities, estate planning, general planning, insurance, investments, planning profession, retirement planning, taxes and more."
    >
      <CustomAutofitGrid>
